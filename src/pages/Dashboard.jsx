  ...
  return (
    <div>
      ...
      <div className="flex">
        ...
        <div className="w-3/4 lg:w-4/5 mx-auto p-8">
          <div className="bg-secondaryColor px-8 py-16 w-11/12 rounded-xl flex items-center relative">
            <div className="w-1/2">
              ...
              <p className="text-gray-500 lg:text-lg font-semibold">
                Have a nice day at work
              </p>
            </div>
            <div className="w-1/2 flex items-center justify-center absolute bottom-0 right-0">
              <img
